...
<div class="form-group">
	 <div class="col-xs-12">
        ...
        <select name="txtPlantilla" class="form-control" id="tit_Plantilla" onchange="preview();">
        <?php
        $plantillas = traer_nombres_plantillas("bootstrap/carteles.css");
        for($i = 0; $i < count($plantillas); $i++)
        {
            echo "<option" . ($plantilla == $plantillas[$i] ? " selected" : "") . ">" . $plantillas[$i] . "</option>";
        }
        ?>
        </select>
